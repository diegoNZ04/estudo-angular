...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, RouterOutlet, FirsComponentComponent, ParentDataComponent, DirectivesComponent, QuadradoifComponent, NgforComponent, NgswitchComponent, NgclassComponent, EventbindingComponent, ControlflowComponent, FormsmoduleComponent, ReactiveformsComponent],
